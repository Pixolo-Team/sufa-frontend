 ...
 *
 * Mirrors the batch-linked shape used by the operations UI:
 * each center owns batches, each batch owns its schedule, plans and
	...
	centers: [
		{
			...
			batches: [
				...
				},
				{
					...
					registrationOptions: [
						{
							id: "east-morning-registration-package",
							name: "Registration Package",
							price: 1160,
						},
						{
							id: "east-morning-starter-package",
							name: "Starter Package",
							price: 2150,
						},
						{
							id: "east-morning-player-package",
							name: "Player Package",
							price: 3560,
						},
					],
			...
			batches: [
				{
					...
					registrationOptions: [
						{
							id: "west-evening-registration-package",
							name: "Registration Package",
							price: 1160,
						},
						{
							id: "west-evening-starter-package",
							name: "Starter Package",
							price: 2150,
						},
						{
							id: "west-evening-player-package",
							name: "Player Package",
							price: 3560,
						},
					],
